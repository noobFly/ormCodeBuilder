...
public class Table {
	...
	public String getClassName() {
	    if(StringHelper.isBlank(className)) {
	        ...
	        String upperCaseWhenPreSigleLetter = GeneratorProperties.getProperty("upperCaseWhenPreSigleLetter", "");
	        className = StringHelper.makeAllWordFirstLetterUpperCase(StringHelper.toUnderscoreName(removedPrefixSqlName), "true".equals(upperCaseWhenPreSigleLetter));
	    }
		return className;
	}
